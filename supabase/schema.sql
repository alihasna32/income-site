...
-- ------------------------------------------------------------
-- Withdrawals (user-submitted, admin-approved)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Daily math challenge (one attempt per user per day)
-- ------------------------------------------------------------
...
-- Withdrawals: users read their own only; writes go through the API (service role).
